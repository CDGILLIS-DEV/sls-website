...
export const metadata: Metadata = {
  ...
  keywords: "logistics, freight, trucking, shipping, freigh broker, best freight broker, small freight broker, excellent freight boker, reliable, reliable freight broker"
};
